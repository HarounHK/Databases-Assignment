...
--This query is choosing to show the individuals who have made an order past a certain date and its not showing null results
...
--Number 4
--Showing the total stock left for all items
